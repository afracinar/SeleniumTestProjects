...
public class Test008 {
    ...
    public void test1(){
        ...
        //4. Click on 'Products'(urunler) button
        driver.findElement(By.xpath("//a[@href='/products']")).click();

        //5. Verify user is navigated to ALL PRODUCTS(tum urunler) page successfully
        ...
        //7. Click on 'View Product' of first product(ilk urunde urunu goruntuleye tiklayin)
        driver.findElement(By.xpath("//*[@href='/product_details/1']")).click();

        //8. User is landed to product detail page(kullanici urun detay sayfasina yonlendirilir)
        ...
        //  ( Ayrıntılarin görünür olduğunu doğrulayın: ürün adı, kategori, fiyat,stok durumu, , marka)
